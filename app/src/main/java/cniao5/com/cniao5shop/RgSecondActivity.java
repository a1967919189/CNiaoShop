...
public class RgSecondActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_rg_second);
        ...
        okHttpHelper.post(Contants.API.REG, params, new SpotsCallBack<LoginRespMsg<User>>(this) {
            ...
            public void onSuccess(Response response, LoginRespMsg<User> userLoginRespMsg) {
                ...
                if(userLoginRespMsg.getStatus()== LoginRespMsg.STATUS_ERROR){
                    ToastUtils.show(RgSecondActivity.this,"注册失败:"+userLoginRespMsg.getMessage());
                    return;
                }
                CniaoApplication application = CniaoApplication.getInstance();
                application.putUser(userLoginRespMsg.getData(), userLoginRespMsg.getToken());

                startActivity(new Intent(RgSecondActivity.this,MainActivity.class));
                finish();
